...
Liverpool Bay - Tidal mixing and ROFI dynamics in Irish Sea

## Overview

**Repository:** [cases/liverpool_bay](https://github.com/gotm-model/cases/tree/master/liverpool_bay)

## Running the Case

```bash
cd cases/liverpool_bay
gotm
```
